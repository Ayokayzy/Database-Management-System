...
const Sidebar = ({ children }) => {
  const { sidebarList, nav, toggleNav } = useContext(GlobalState);
    ...
    <div>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 scrollbar-hide">
          ...
          <ul className="space-y-2 font-medium mb-32">
            {sidebarList.map((list) =>
              list.type === "button" ? (
                <DropdownNavMenu name={list.name} links={list.links} />
              ) : (
                <DefaultLilnk name={list.name} url={list.url} />
              )
            )}
          </ul>
          <div>
